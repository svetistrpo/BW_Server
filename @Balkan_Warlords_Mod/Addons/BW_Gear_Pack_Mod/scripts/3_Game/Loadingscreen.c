modded class LoginQueueBase extends UIScriptedMenu
{
	...
	{	
		layoutRoot = GetGame().GetWorkspace().CreateWidgets("BW_Gear_Pack_Mod/gui/ftm_dialog_queue_position.layout");
...
modded class LoginTimeBase extends UIScriptedMenu
{
	...
	override Widget Init()
	{	
		layoutRoot = GetGame().GetWorkspace().CreateWidgets("BW_Gear_Pack_Mod/gui/ftm_dialog_login_time.layout");
...
modded class LoadingScreen
{
	...
	void LoadingScreen(DayZGame game)
	{
		...
		m_WidgetRoot = game.GetLoadingWorkspace().CreateWidgets("BW_Gear_Pack_Mod/gui/ftm_loading.layout");
...
modded class ConnectionLost
{
	...
	{		
		m_WidgetRoot = game.GetWorkspace().CreateWidgets("BW_Gear_Pack_Mod/gui/ftm_day_z_connection_lost.layout");
		m_WidgetRoot.Show(false);
